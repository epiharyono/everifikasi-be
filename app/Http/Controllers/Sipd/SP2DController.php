...
{
    static function SingkronSP2D($req){
    ...
    static function SingkronSP2DCetak($req){
        $message = 'Sing Singkron SP2D Cetak';
        $header = '';
        $data = $req->data;
        $data = json_decode($data, true);
        $id   = $req->id_sp_2_d;
              ...
              elseif($jenis == 'GU'){
                  ...
                  if(!$cek){
                      DB::table('ta_sppd_cetak')->insert([
                          ...
                          'nomor_sp_2_d' => $data['nomor_sp_2_d'],
                          'tanggal_sp_2_d' => $data['tanggal_sp_2_d'],
                          'nama_skpd' => $data['nama_skpd'],
                          'nama_bp_bpp' => $data['nama_bp_bpp'],
                          'nip_bp_bpp' => $data['nip_bp_bpp'],
                          'jabatan_bp_bpp' => $data['jabatan_bp_bpp'],
                          'no_rek_bp_bpp' => $data['no_rek_bp_bpp'],
                          'nama_rek_bp_bpp' => $data['nama_rek_bp_bpp'],
                          'bank_bp_bpp' => $data['bank_bp_bpp'],
                          'npwp_bp_bpp' => $data['npwp_bp_bpp'],
                          'keterangan_sp2d' => $data['keterangan_sp2d'],
                          'nilai_sp2d' => $data['nilai_sp2d'],
                          'nomor_spm' => $data['nomor_spm'],
                          'tanggal_spm' => $data['tanggal_spm'],
                          'nama_ibu_kota' => $data['nama_ibu_kota'],
                          'nama_bud_kbud' => $data['nama_bud_kbud'],
                          'nip_bud_kbud' => $data['nip_bud_kbud'],
                          'jabatan_bud_kbud' => $data['jabatan_bud_kbud'],
                      ]);
                  }
